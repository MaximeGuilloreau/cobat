...
class JwtLoginAuthenticator extends AbstractGuardAuthenticator
{
    ...
    {
        return new JsonResponse(['message' => $authException->getMessageKey()], Response::HTTP_UNAUTHORIZED);
    }
    ...
    public function getCredentials(Request $request)
    {
        ...
        if (null !== $credentials && isset($credentials['password'], $credentials['username']) ) {
            return [
